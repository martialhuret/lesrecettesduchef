...
<body>
	<div id="Avis">
		...
		echo "<h1>Modifier votre pseudo ici !</h1>
		...
		<div id='formPseudo'>
			<form action='controleur.php' method='GET'>
				...
				" ?>
		<div class="log">
			<p>Nouveau pseudo: </p><input type="text" id="pseudo" name="pseudo" value="" required />
		</div><br />
		<input type="submit" name="action" value="Modifier le pseudo" id="envoyer" />
		</form>
	</div>
